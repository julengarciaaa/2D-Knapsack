...
class SolverDTS:
    def __init__(self, n_pop, n_gen, n_rep, cxpb, mutpb, container_filler, alpha=1, beta=1):
        ...
        layer_filler_aux = LayerFillerRTS(s_depth=1, s_width=1)
        self.population_generator = ContainerFillerRTS(n1=1, n2=1, layer_filler=layer_filler_aux)
        self.n_pop = n_pop
        self.n_gen = n_gen
        self.n_rep = n_rep
        self.cxpb = cxpb
    ...
    def generate_initial_population(self, n_pop, container, warehouse):
        ...
        for i in range(n_pop):
            state = self.population_generator.fill_container(
            container, 
            warehouse)[0]
    ...
    def solve(self, container, warehouse):
        ...
        for g in range(self.n_gen):
            ...
            end_alg = time.time()
            duration_alg = end_alg - start_alg
